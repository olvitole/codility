...
/**
 * 3.1 Implement 3 stacks in one array
 */
...
public class Q3Dot1 {
	...
	public static void main(String args[]) throws Exception {
		...
		System.out.println();
		System.out.println("B cases");

		MultiStack stacks1 = new MultiStack(3, 4);
		printStacks(stacks1);
		stacks1.push(0, 10);
		printStacks(stacks1);
		stacks1.push(1, 20);
		...
		System.out.println("Final Stack: " + Arrays.toString(stacks1.getValues()));
...
class MultiStack {
	 ...
	 * just a bunch of individual variables, but that’s messy and doesn’t gain
	 * us much.
	 */
	...
	private int adjustIndex(int index) {
		 ...
		 * will return -1, not 4. We actually want the value to be 4 (since
		 * we're wrapping around the index).
		 */
